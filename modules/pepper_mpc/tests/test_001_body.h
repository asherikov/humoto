        ...
        namespace HUMOTO_TEST_SOLVER_NAMESPACE
        {
            class ControllerSingleRunBase : public humoto_tests::SolverPerformanceSingleRunBase
            {
                ...
                public:
                    ...
                    {
                        robot_parameters_.readConfig<humoto::config::yaml>(config_path + "robot_parameters.yaml");
                        mg_parameters_.readConfig<humoto::config::yaml>(config_path + "mpc_parameters.yaml");
                        motion_parameters_.readConfig<humoto::config::yaml>(config_path + "motion_parameters_circle_fast.yaml");
                        model_state_.readConfig<humoto::config::yaml>(config_path + "initial_state_pepper.yaml");
