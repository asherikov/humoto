...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        mg_parameters.readConfig<humoto::config::yaml>(config_path + "mpc_parameters.yaml");
        ...
        motion_parameters.readConfig<humoto::config::yaml>(config_path + "motion_parameters_circle_fast.yaml");
